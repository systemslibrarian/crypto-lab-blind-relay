...
> = {
  "control-boundary|a.cl-btn": { ratio: 1.29, required: 3.0, unverified: false },
  "control-boundary|button#all-btn.btn": { ratio: 1.6, required: 3.0, unverified: false },
  ...
  "control-boundary|button#next-btn.btn": { ratio: 1.6, required: 3.0, unverified: false },
  "control-boundary|button#play-btn.btn": { ratio: 1.6, required: 3.0, unverified: false }
};
